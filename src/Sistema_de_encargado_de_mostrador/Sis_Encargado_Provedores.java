 ...
 */
public class Sis_Encargado_Provedores extends javax.swing.JFrame {
    ...
    List<Integer> cambios_provs = new ArrayList<>();
    List<String> cambios_provs_nom=new ArrayList<>();
    
    List<Integer> rows_de_provs_seleccionados;
    List<Proveedor> provs_originales;
    
    public Sis_Encargado_Provedores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton_AbirModuloProductos = new javax.swing.JButton();
        ...
        jPanel_BajaProveedorLayout.setHorizontalGroup(
            ...
            .addGroup(jPanel_BajaProveedorLayout.createSequentialGroup()
                ...
                .addGroup(jPanel_BajaProveedorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButton_BajaProveedor_DarDeBaja, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
        ...
        jTable_CambiosProveedor.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        ...
        jButton_AbirModuloProductos.setText("Abrir Módulo de productos");
        jButton_AbirModuloProductos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton_AbirModuloProductosActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButton_AbirModuloProductos))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private void jButton_AbirModuloProductosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_AbirModuloProductosActionPerformed
        ...
        this.dispose();
        fp.setVisible(true);
    }//GEN-LAST:event_jButton_AbirModuloProductosActionPerformed
       ...
       if(jTable_AltaProveedor.isEditing())
        ...
        int provee_nuevos=0;
            for(int i=dfm_AltaProveedor.getRowCount()-1;i>=0;i--){                                    
                ...
                catch(Throwable e){ JOptionPane.showMessageDialog(null, "Ingrese correctamente los datos", "Atención",JOptionPane.WARNING_MESSAGE);
                while(dfm_AltaProveedor.getRowCount() > 0){dfm_AltaProveedor.removeRow(0);}
                }
            } 
            if(provee_nuevos==1){
        ...
        for(int i=0;i<rows_de_provs_seleccionados.size();i++){
            try{        
                ...
                if(nombre.contains("|")||calle.contains("|")||colonia.contains("|")||municipio.contains("|")||estado.contains("|"))
                    JOptionPane.showMessageDialog(null, "Por favor evite el uso del caracter \"|\" en los datos del proveedor \""+cambios_provs_nom.get(i)+"\"", "Atención",JOptionPane.WARNING_MESSAGE);
                else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sis_Encargado_Provedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sis_Encargado_Provedores().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton jButton_AbirModuloProductos;
